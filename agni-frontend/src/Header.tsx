...
import { Flame, RefreshCw, Shield, Map } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <Link 
              to="/"
              className="px-2 py-1 md:px-4 md:py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition cursor-pointer text-sm md:text-base flex items-center gap-1"
            >
              <Map className="w-3 h-3 md:w-4 md:h-4" />
              <span className="hidden md:inline">View Live Map</span>
              <span className="md:hidden">🗺️</span>
            </Link>
            <Link 
              to="/first-responders"
              className="px-2 py-1 md:px-4 md:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition cursor-pointer text-sm md:text-base flex items-center gap-1"
            >
              <Shield className="w-3 h-3 md:w-4 md:h-4" />
              <span className="hidden md:inline">First Responders</span>
